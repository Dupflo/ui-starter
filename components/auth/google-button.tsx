...
export function GoogleButton({ label }: { label: string }) {
  ...
  return (
    <button
      ...
      onClick={signIn}
      disabled={pending}
      className="flex h-11 w-full items-center justify-center gap-2.5 rounded-xl border border-line bg-input text-sm font-semibold text-ink-strong transition-colors hover:bg-fill disabled:opacity-70"
    >
      <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden="true">
        {/* design-tokens-allow: Google brand colours per brand guidelines */}
        <path
          fill="#4285F4"
